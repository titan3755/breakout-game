use bevy::prelude::*;
use crate::components::{Ball, Player, Speed};
use crate::{BALL_RADIUS, HEIGHT, PLAYER_DIMENSIONS, WIDTH};
...
pub fn ball_wall_collision_system(mut ball_query: Query<(&Transform, &mut Speed), With<Ball>>) {
